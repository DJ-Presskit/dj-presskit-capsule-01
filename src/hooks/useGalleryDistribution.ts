 ...
 */
export function useGalleryDistribution(allImages: GalleryImage[] | undefined): GalleryDistribution {
  return useMemo(() => {
...
export default useGalleryDistribution;
