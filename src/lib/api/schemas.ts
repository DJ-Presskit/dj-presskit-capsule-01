...
export const PresskitSeoSchema = z
  .object({
...
export const PresskitProfileSchema = z
  .object({
...
export const PresskitThemeSchema = z
  .object({
    accentColor: z.string(),
    backgroundTint: z.string().nullable().optional(),
    heroMediaType: z.enum(["video", "image", "none"]).optional(),
    heroVideoCloudflareId: z.string().optional(),
    background: z
      .object({
 ...
 */
export const PresskitMinimalSchema = z
  .object({
    id: z.string(),
    slug: z.string(),
    artistName: z.string(),
